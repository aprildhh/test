...
URL ="http://localhost/Public/js/uedeitor/";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[["Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","Superscript","Subscript","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","touppercase","tolowercase","Indent","RemoveFormat","FormatMatch","AutoTypeSet","PastePlain","CustomStyle","Paragraph","RowSpacingBottom","RowSpacingTop","LineHeight","FontFamily","FontSize","ImageNone","ImageLeft","ImageRight","ImageCenter","InsertImage","Emotion","InsertVideo","Source","InsertUnorderedList","InsertOrderedList","Unlink","Link","ClearDoc","SelectAll","Preview"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','backcolor':'','superscript':'','subscript':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','touppercase':'','tolowercase':'','indent':'','removeformat':'','formatmatch':'','autotypeset':'','pasteplain':'','customstyle':'','paragraph':'','rowspacingbottom':'','rowspacingtop':'','lineheight':'','fontfamily':'','fontsize':'','imagenone':'','imageleft':'','imageright':'','imagecenter':'','insertimage':'','emotion':'','insertvideo':'','source':'','insertunorderedlist':'','insertorderedlist':'','unlink':'','link':'','cleardoc':'','selectall':'','preview':''}
