...
<!-- body -->
	<div class="body">
		<div class="server">
			<ul>
				<li><span class="span1"><b>服务器名称</b></span><span class="span2"><b>服务器IP</b></span><span class="span3"><b>开放时间</b></span><span class="span4"><b>线路·</b></span><span class="span5"><b>版本介绍</b></span><span class="span6"><b>客服QQ</b></span><span class="span7"  style="*width:93px;" style="*width:93px;"><b>客服QQ</b></span></li>
                <div id="col">
				 <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="background:#FFFF99" onmouseover="moin(this)" onmouseout="moout(this)"><span class="span1"><a href="/show/preview/id/<?php echo ($vo["pid"]); ?>.html" target="_blank"><?php echo ($vo["name"]); ?></a></span><span class="span2"><a href="/show/preview/id/<?php echo ($vo["pid"]); ?>.html" target="_blank"><?php echo ($vo["serverip"]); ?></a></span><span class="span3"><?php echo (date("Y/m/d H:i:s",$vo["server_time"])); ?>开放</span><span class="span4"><?php echo ($vo["line_type"]); ?></span><span class="span5"><?php echo ($vo["version"]); ?></span><span class="span6"><?php echo ($vo["qq"]); ?></span><span class="span7"  style="*width:93px;"><a href="/show/preview/id/<?php echo ($vo["pid"]); ?>.html">详情</a></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
			</ul>
		</div>
	</div>
    <script>
        function moin(ob){
            $(ob).css("background","#DFFFF3");
        }
        function moout(ob){
            $(ob).css("background","#FFFF99");
        }
    </script>
<!-- /body -->
